...
import VisualizarParcela from './VisualizarParcela';
              ...
              <div className="car-td car-td-total">
                <div className="car-total-cell">
                  ...
                  <div className="car-hover-icons-container">
                    <button className="car-btn-icon-action" title="Visualizar" onClick={() => {
                      const empresasMap = {
                        '1': '1 - MATRIX LOGISTICS BRASIL LTDA - 07.654.321/0001-44',
                        '2': '2 - TECHSOLUTIONS DISTRIBUIDORA LTDA - 08.765.432/0001-55',
                        '3': '3 - PALMAS TEC DISTRIBUIDORA EIRELI - 11.882.936/0001-00',
                        '4': '4 - ELITE COMMERCE SOLUTIONS - 12.345.678/0001-99',
                        '5': '5 - INNOVATE DISTRIBUTION BRASIL - 13.456.789/0001-88',
                        '6': '6 - PRIME LOGISTICS GROUP LTDA - 14.567.890/0001-77',
                        '7': '7 - QUANTUM SUPPLY CHAIN LTDA - 15.678.901/0001-66'
                      };
                      const empresaNome = empresasMap[row.emp] || `${row.emp} - EMPRESA PADRÃO LTDA - 00.000.000/0001-00`;
